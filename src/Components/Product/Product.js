      ...
      <div>
        <div className="card_container">
          <div className="card" onClick={this.changeCard0}>
            <img src="https://i.imgur.com/DNkikUV.jpg" alt="cfd photo" />
          ...
          <div className="card" onClick={this.changeCard1}>
            <img src="https://i.imgur.com/rmWiv5W.png" alt="cfd photo" />
            <div className="container">
          ...
          <div className="card" onClick={this.changeCard2}>
            <img src="https://i.imgur.com/Wa21EPT.png" alt="cfd photo" />
            <div className="container">
